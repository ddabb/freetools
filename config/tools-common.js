...
const commonTools = [
  ...
  { id: 'merge-abc', name: 'ABC合成记', icon: '🔤', color: 'amber', url: '/packages/life/pages/merge-abc/merge-abc', categories: ['休闲工具'], keywords: ['ABC', '合成', '字母', '合并', '游戏', 'merge', '益智'], description: '合并相同字母进化，趣味字母合成游戏' },
