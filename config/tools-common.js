...
const commonTools = [
  ...
  { id: 'merge-abc', name: 'ABC合成记', icon: '🔤', color: 'amber', url: '/packages/life/pages/merge-abc/merge-abc', categories: ['休闲工具'], keywords: ['ABC', '合成', '2048', '字母', '合并', '游戏', 'merge'], description: '合并相同字母进化，类似2048的字母合成游戏' },
