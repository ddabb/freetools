...
| 数据 | jsDelivr CDN 地址 |
|------|------------------|
| 版本日志 | `https://cdn.jsdelivr.net/gh/ddabb/freetools@main/data/changelog.json` |
| 每日数独 | `https://cdn.jsdelivr.net/gh/ddabb/freetools@main/data/daily-sudoku.json` |
| 星座信息 | `https://cdn.jsdelivr.net/gh/ddabb/freetools@main/data/constellation-info.json` |
| 亲戚关系 | `https://cdn.jsdelivr.net/gh/ddabb/freetools@main/data/relative-relation.json` |
| 文案索引 | `https://cdn.jsdelivr.net/gh/ddabb/freetools@main/data/wordbank/index.json` |
| 生日文案 | `https://cdn.jsdelivr.net/gh/ddabb/freetools@main/data/wordbank/birthday.json` |
| 24点题库 | `https://cdn.jsdelivr.net/gh/ddabb/freetools@main/data/24point-questions.json` |
| **毒鸡汤** | `https://cdn.jsdelivr.net/gh/ddabb/freetools@main/data/wordbank/poison-soup.json` |
| **答案之书** | `https://cdn.jsdelivr.net/gh/ddabb/freetools@main/data/wordbank/answer-book.json` |
| 成语首字 | `https://cdn.jsdelivr.net/gh/ddabb/freetools@main/data/idiom-solitaire/idiom-first-index.json` |
