...
// 设置初始问题索引
  ...
  MergeImage: function (res) {
    ...
    // 加载并绘制二维码
    const img = canvasObj.createImage();
    img.onload = () => {
      ...
      wx.canvasToTempFilePath({
        ...
        quality: 1,
        canvas: canvasObj,
        destWidth: width * (wx.getSystemInfoSync().pixelRatio / 2),
        destHeight: height * (wx.getSystemInfoSync().pixelRatio / 2),
        success: (res) => {
          wx.hideLoading();
