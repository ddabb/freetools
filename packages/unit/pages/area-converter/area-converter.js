...
Page({
  data: {
    units: ['平方毫米', '平方厘米', '平方分米', '平方米', '平方千米', '公顷', '亩', '平方英尺', '平方�?:', '平方英寸', '英亩', '平方英里'],
    unitValues: {
      '平方毫米': '',
      '平方厘米': '',
      '平方分米': '',
  ...
  toBaseUnit(value, unit) {
    const areaMap = {
      ...
      '平方英尺': 0.092903, '平方�?:': 0.836127, '平方英寸': 0.00064516, '英亩': 4046.86, '平方英里': 2589988.11
    }
  ...
  fromBaseUnit(baseValue, unit) {
    const areaMap = {
      ...
      '平方英尺': 10.7639, '平方�?:': 1.19599, '平方英寸': 1550, '英亩': 0.000247105, '平方英里': 3.86102e-7
    }
